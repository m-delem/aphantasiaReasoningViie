...
package. It contains the code and data to reproduce the analyses presented in the paper "*The Impact of Mental Images on Reasoning: A Study on Aphantasia*" (preprint coming soon).
